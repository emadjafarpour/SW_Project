        ...
        public ActionResult Create(StaticContentDetail staticContentDetail, HttpPostedFileBase StaticContentDetailImage)
        {
            if (ModelState.IsValid)
            {
                ...
                if (StaticContentDetailImage != null)
                {
                    ...
                    if (staticContentDetail.StaticContentTypeId == (int)StaticContentTypes.SidebarImages)
                        image = new ImageResizer(400, 400, true);
                    else if(staticContentDetail.StaticContentTypeId == (int)StaticContentTypes.CollectionBanner)
                    {
                        image = new ImageResizer(1140, 420, true);
                    }
